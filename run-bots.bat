...
start cmd /c "python main.py --logic DiamondOnly --email=test1@email.com --name=stima1 --password=123456 --team etimo"
start cmd /c "python main.py --logic Random --email=test2@email.com --name=stima2 --password=123456 --team etimo"
start cmd /c "python main.py --logic DiamondOnly --email=test3@email.com --name=stima3 --password=123456 --team etimo"
